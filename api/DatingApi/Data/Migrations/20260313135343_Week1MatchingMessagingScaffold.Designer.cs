...
namespace DatingApi.Data.Migrations
{
    ...
    [Migration("20260313135343_Week1MatchingMessagingScaffold")]
    partial class Week1MatchingMessagingScaffold
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DatingApi.Domain.ConversationState", b =>
                {
                    ...
                    b.Property<DateTime?>("FirstReplyAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("DatingApi.Domain.Match", b =>
                {
                    ...
                    b.Property<string>("CompatibilityReasonsJson")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("DatingApi.Domain.ConversationState", b =>
                {
                    b.HasOne("DatingApi.Domain.Match", "Match")
                        .WithOne()
                        .HasForeignKey("DatingApi.Domain.ConversationState", "MatchId")
